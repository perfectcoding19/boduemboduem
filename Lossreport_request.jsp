...
try{
    ...
    String lostplace=multi.getParameter("place") + " " + multi.getParameter("place1"); 
    String lostday = multi.getParameter("day");
    ...
    try{
    	...
    	String sql = "insert into lossreport(variety, sex, old, lostplace, lostday, feature, callnumber,filename) values('"+variety+"','"+sex+"','"+old+"','"+lostplace+"','"+lostday+"','"+feature+"','"+callnumber+"','"+originalFile+"');";
