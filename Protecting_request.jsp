...
try{
    ...
    String protectplace=multi.getParameter("place") + " " + multi.getParameter("place1"); 
    String protectday = multi.getParameter("day");
    ...
    try{
    	...
    	String sql = "insert into protecting(variety, sex, old, protectplace, protectday, feature, callnumber, filename) values('"+variety+"','"+sex+"','"+old+"','"+protectplace+"','"+protectday+"','"+feature+"','"+callnumber+"','"+originalFile+"');";
