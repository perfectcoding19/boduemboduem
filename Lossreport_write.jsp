...
<tr>
 ...
 <td>
 <div>
 <input type="hidden" name="sex1" id="sex1" value="" required>
 <input type="checkbox" name="sex" value="남" onclick="oneCheckbox(this)">남
 <input type="checkbox" name="sex" value="여" onclick="oneCheckbox(this)">여
 </div>
 </td>
 </tr>
 <tr>
 ...
 <tr>
   <th>• 분실 날짜*</th>
     <td>
       <input type="text" name="day" value="" placeholder=" ex)991231"></input>
     </td>
 </tr>
