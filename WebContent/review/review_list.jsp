...
<body>
	<script type="text/javascript">
    	...
    	function popup_write_open(pageType) {
			window.open(
    		"review_popup_write.jsp?type="+pageType,
    		"new",
    		"width="+_width+",height="+_height+",top="+_top+",left="+_left+", scrollbars=no");
    	}    
	...
	<form>
                    ...
                    <table width="100%">
                        <tr>
							...
							<td width="30%" align="right">
								<div>
									<input type="button" onclick="popup_write_open('<%=pageType%>');" value="글작성">
								</div>
							</td>
                        </tr>
                    </table>
		...
		<% 
				...
				try {
				    ...
				    while(rs.next()) {
				    	...
				    	out.print("		<tr>");
				    	out.print("			<td align='center'><img src='../image/"+rs.getString("image")+"' width='240' height='240'"); 
		...
		%>
		        <a href='javascript:review_list(<%=i %>);'>[<%=i%>]</a>
		<%
		        };
		%>
				</td>
