...
<link rel="stylesheet" type="text/css" href="../main/footer_s.css">
...
#button{float:right;border:2px solid #c7d696; background:#c7d696; font-family:"맑은 고딕";}
...
<form action="Totalnotice_request.jsp" enctype="multipart/form-data" method="post">
...
<tr>
 ...
 <tr>
  ...
  <option>선택</option>
      ...
      <input type="text" name="place2" placeholder="상세한 장소를 입력하세요." style="width:200px;" ></input>
   </td>
 </tr>
...
<button id="button" type="button" onclick="location.href='Totalnotice_board.jsp'"> 취소 </button>
