...
<body>
	...
	try {
		...
		try {
			...
			String sql = "insert into Totalnotice(variety, variety1, sex, old, place, place1, place2, day, feature, callnumber, filename) values('"
	...
	response.sendRedirect("Totalnotice_board.jsp");
	%>
</body>
</html>