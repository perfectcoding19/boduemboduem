...
try{
    ...
    try{
    	...
    	String sql = "insert into protecting(variety, variety1, sex, old, place, place1, place2, day, feature, callnumber, filename) values('"+variety+"','"+variety1+"','"+sex+"','"+old+"','"+place+"','"+place1+"','"+place2+"','"+day+"','"+feature+"','"+callnumber+"','"+originalFile+"');";
