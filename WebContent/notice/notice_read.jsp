...
<body>
	...
	<div class="section">
		...
		<form id="form1" action="notice_list.jsp" method="post">
			<input type=hidden name="page" value="<%=tempStart%>"> <input
		...
		<form id="form2" action="notice_write.jsp" method="post">
			...
			<div align="center">
				<input
					style="border-radius: 5px; border: 2px solid #c7d696; background: #c7d696; font-size: 15px; cursor: pointer;"
					type="button" onclick="notice_list()" value="목록">
