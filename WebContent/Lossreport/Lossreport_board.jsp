...
<body>
	...
	try {
		...
		String sql = String.format("select * from lossreport WHERE 1=1 %s order by idx desc limit %d,%d;", where, pageNum,
		term);
	...
	<div class="section">
		...
		<div class="main">
			...
			<div style="display: inline-block; margin-left: 50%">
				...
				%>
				<a style="color: black;" href="Lossreport_board.jsp?pageCnt=<%=i%>"><%=i%></a>
				<%
					}
				%>
			</div>
			...
			%>
			<button id="button" onclick="location.href='Lossreport_write.jsp'"
