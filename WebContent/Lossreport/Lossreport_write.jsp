...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="../Totalnotice/write_s.css">
<title>분실 신고</title>
...
<body>
	...
	<div class="section">
		<form action="Lossreport_request.jsp" enctype="multipart/form-data"
			method="post">
			<div id="notice">분실 신고
			<hr style="margin-top: 15px;" width="100%" color=#c7d696></div>
			<table>
				<tr>
					<th>• 품종</th>
					...
					<td>
						<div>
							<input type="hidden" name="sex1" id="sex1" value=""> <input
								...
								name="sex" value="암컷" onclick="oneCheckbox(this)"> 암컷
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select name="place" onchange="categoryChange(this)">
							...
							<option>선택</option>
					</select> <input type="text" name="place2" placeholder="상세한 장소를 입력하세요."
			...
			<div class="button">
				...
				<button type="button" onclick="location.href='Lossreport_board.jsp'">취소</button>
			</div>
		</form>
	</div>
	<div class="footer">
